...
- **Fast performance**: multiply the speed of execution by 5~15 folds 💨
...
Here's the [final code](https://github.com/renanmav/react-native-in-app-browser) for the module if you want to check it out. Also available as an NPM package:
...
- https://github.com/4cc3ssX/react-native-nitro-totp
