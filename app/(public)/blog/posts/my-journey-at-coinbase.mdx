...
1. **[react-navigation](https://reactnavigation.org) scaffolding**: Coinbase Wallet navigation setup in `apps/rn`, including `TabNavigator` and `StackNavigator`, as well as basic deep linking setup. At that time, we were using react-navigation v4. It was later updated to v5 and then to v6.
