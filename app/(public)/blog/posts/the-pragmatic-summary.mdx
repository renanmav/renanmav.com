...
Axiom of life: you can't write perfect software. Accept it. Turn that depressing reality into an advantage. Code defensively, don't trust other people's code. If there's any doubt, validate all information you're given. Don't trust yourself either. When everybody is out to get you, paranoia is just good thinking. Play it safe.

{/* Design by Contract */}

Client and suppliers must agree on rights and responsibilities. Design by contract is a way to ensure that both parties understand the expectations and constraints of the relationship.

{/* Dead Programs Tell No Lies */}

Ensure that your code does no damage while you're working the bugs out. Try to check things often and terminate the program if things go <Tooltip content="away from the appropriate, planned, or expected course.">awry</Tooltip>.
